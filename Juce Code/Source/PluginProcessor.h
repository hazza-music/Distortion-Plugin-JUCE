...
/**
*/
class Distortionpass1AudioProcessor  : public juce::AudioProcessor
{
public:
    //==============================================================================
    Distortionpass1AudioProcessor();
    ~Distortionpass1AudioProcessor() override;
...
private:
    ...
    // Functions in PluginProcessor.cpp
    float previousGain;
    ...
    //==============================================================================
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (Distortionpass1AudioProcessor)
};
